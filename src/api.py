...
def help():
    ...
    endpoints = {
        ...
        'POST /jobs/<hour>': '''Create a job to find flights within an altitude range for a specific hour (requires min_altitude and max_altitude in JSON body) example command: curl -X POST http://127.0.0.1:5000/jobs/<hour> -H "Content-Type: application/json" -d '{"min_altitude":10000, "max_altitude":12000}' ''',
